...
let loadCurveData= []
let loadCurveLabel= []
let loadCurveMonthData= []
let loadCurveMothLabel= []
let loadCurveMonthDataPrevious= []
let loadCurveDataPrevious= []
let peakValueData= []
let peakValueLabel= []
let loadCurveDataOne= []
let loadCurveLabelOne= []
let loadCurveDataTwo= []
let loadCurveLabeTwo= []
let data= []
let label= []
